...
,isc.A.generateJSCallback=function isc_c_Comm_generateJSCallback(_1){var _2=_1.transactionNum,_3=_1.callback,_4=isc.Comm.alwaysSendInNewWindow?"window.opener.parent.isc.Comm.hiddenFrameReply("+_2+",results,window)":("while (!window.isc && document.domain.indexOf(\".\") != -1) {"+"try { parent.isc; break} catch (e) {"+"document.domain = document.domain.replace(/.*?\\./, \"\")}}"+"parent.isc.Comm.hiddenFrameReply("+_2+",results)");_1.requestData.jscallback=_4;this.$50c[_2]=_3}
...
_5=_5.name;if(isc.isA.FilterBuilder(this.filterBuilder)){_8=this.filterBuilder.getEditorType(_1,_2.ID)}
if(_4=="valueSet"){return}else if(_4=="fieldType"||_4=="custom"){if(_4=="custom"&&_2&&_2.editorType){_8=_2.editorType}
