...
var _1=this.$167;if(isc.Browser.isIE&&_1!=this.getActiveElement()){this.logInfo("not returning focus element "+isc.echoLeaf(_1)+" since it doesn't match document.activeElement","nativeFocus");if(this.hasFocus){this.hasFocus=false;this.elementBlur()}
...
);isc.evalBoundary;isc.B.push(isc.A.isDisabled=function isc_FormItem_isDisabled(){var _1=this.disabled
...
{_17=true;var _13=_9["=="];var _21=_13.find({"ID":"equals"});_18=_21.wildCard}
...
,isc.A.placeCanvas=function isc_CanvasItem_placeCanvas(_1){var _2=this.canvas;if(_2.destroyed)return;if(this.visible==false){_2.hide();_2.moveTo(0,0);return}
...
,isc.A.shouldDisableCanvas=function isc_CanvasItem_shouldDisableCanvas(){return this.disabled==true}
...
,isc.A.setElementReadOnly=function isc_CanvasItem_setElementReadOnly(){this.$176(!this.isDisabled())}
...
,isc.A.$884=function isc_TextItem__shouldSelectOnFocus(){if(this.$93l)return false;var _1=this.selectOnFocus;if(_1==null&&this.form)_1=this.form.selectOnFocus;if(_1){var _2=isc.EH.isMouseEvent();if(_2)_1=false}
return _1}
...
if(this.mask){this.$717(false);var _5=0;var _6=this.$718;var _7=!_3&&this.$884();if(_7==null&&this.form)_7=this.form.selectOnFocus;if(!_7){_5=this.$719();_6=_5}
...
var _10=this.form,_11=this.form?this.form.getValues():null,_12=(this.formatEditorValue!=null)?this.formatEditorValue(_1,_11,_10,this):_1;this.setElementValue(_12);this.updateValue()}
...
,isc.A.saveValue=function isc_PickTreeItem_saveValue(_1,_2){if(this.$93r!=null){this.$21n=this.$93r;delete this.$93r}else{var _3=this.$21s(this.getValue());this.$21n=_3;if(this.canvas){this.canvas.setSelectedItem(_3)}}
return this.Super("saveValue",arguments)}
