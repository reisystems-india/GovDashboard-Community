		...
		return this.each(function() {
			...
			function buildBody (table) {
				...
				if(options.height != null &&  !isNaN(parseInt(options.height))) {
                    /*PATCH - Height adjustment based on table header height*/
                    options.height = options.height-_headerscontainer.height();
                    /*END OF PATCH - Height adjustment based on table header height*/
