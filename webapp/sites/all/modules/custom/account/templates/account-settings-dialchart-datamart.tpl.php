...
?>
<div class="highcharts-title"><?php echo $datamart_chart['active'].' Topics Activated ('.$datamart_chart['max'].'  Max)';?></div>
<div class="highcharts-dial" id="active-datamart-dial"></div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        // Build the dial
        var dial = drawDial({
            renderTo: 'active-datamart-dial',
            value: <?php echo $datamart_chart['calculated']; ?>,
            centerX: 200,
            centerY: 200,
            min: 0,
            max: <?php echo $datamart_chart['max']; ?>,
            minAngle: -Math.PI,
            maxAngle: 0,
            tickInterval: <?php echo round(($datamart_chart['max'] * 20) / 100); ?>,
            ranges: [
                {
                    from: 0,
                    to: <?php echo round(($datamart_chart['max'] * 20) / 100); ?>,
                    color: '#1C3F95'
                },
                {
                    from: <?php echo round(($datamart_chart['max'] * 20) / 100); ?>,
                    to: <?php echo round(($datamart_chart['max'] * 60) / 100); ?>,
                    color: '#E98035'
                },
                {
                    from: <?php echo round(($datamart_chart['max'] * 60) / 100); ?>,
                    to: <?php echo $datamart_chart['max']; ?>,
                    color: '#C41230'
                }
            ]
        });
