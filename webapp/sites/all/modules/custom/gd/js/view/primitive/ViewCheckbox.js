...
(function(global,undefined){
    ...
    (function($,Highcharts) {
        ...
        var ViewCheckbox = GD.ViewPrimitive.extend({
            text: null,

            init: function ( object, container, options ) {
                this._super(object,container,options);

                this.formitem = $('<input tabindex="3000" class="'+this.getViewCss()+'" type="checkbox" />');
            ...
            getId: function () {
                return GD.Util.IdGenerator.getId({name: typeof this.options['FilterName'] != 'undefined' ? this.options['FilterName'] : 'gd-view-checkbox'});
            },

            getViewCss: function () {
                return this._super() + ' gd-view-checkbox';
            },

            getLabelCss: function () {
                return this._super() + ' gd-label-checkbox';
            },

            getContainerCss: function () {
                return this._super() + ' gd-container-checkbox';
            },
            ...
            setValue: function ( value ) {
                ...
                this.text = $('<label class="'+this.getLabelCss()+'" for="'+this.formitem.attr('id')+'">'+value+'</label>');
            },
        ...
        global.GD.ViewCheckbox = ViewCheckbox;
