...
(function(global,$,undefined) {
    ...
    if ( typeof $ === 'undefined' ) {
        throw new Error('DateTimeFilterForm requires jQuery');
    }

    if ( typeof global.GD === 'undefined' ) {
        throw new Error('DateTimeFilterForm requires GD');
    }

    var GD = global.GD;

    global.GD.DateTimeFilterForm = GD.FilterForm.extend({
        textInput: null,
        ...
        validateValues: function(messages) {
            ...
            if(this.getValue() ){
                if (!GD.Utility.isValidDateTime(this.getValue())) {
            ...
            if (GD.OperatorFactory.isRangeOperator(this.getOperator()) && this.getSecondValue()) {
                if (!GD.Utility.isValidDateTime(this.getSecondValue())) {
                    messages.push('Please enter a valid value.');
