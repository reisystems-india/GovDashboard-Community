...
(function(global,undefined){
    ...
    if ( typeof global.GD === 'undefined' ) {
        throw new Error('ReportContentViewTable requires GD');
    }
    ...
    (function($,Highcharts) {
        ...
        if ( typeof $ === 'undefined' ) {
            throw new Error('ReportContentViewTable requires jQuery');
        }

        var ReportContentViewTable = GD.ReportContentViewDefault.extend({

            init: function ( object, container ) {
                this._super(object, container);

                this.report = $(this.object.table);
                this.tableSort = [];
            },
        ...
        global.GD.ReportContentViewTable = ReportContentViewTable;
