...
(function (global, $, undefined) {
    ...
    var UriHandler = GD.Class.extend({
        ...
        addFilter:function (filter, dashboard) {
            if (dashboard !== undefined) {
                ...
                if (filter.getValue() != null) {
                    this.queryObject.t[dashboard][filter.name].v = filter.getValue();
                }
            } else {
        ...
        getURI:function () {
            return this.scheme + '://' + this.host + this.path + this.getQueryString(this.queryObject);
        },
    ...
    global.GD.UriHandler = UriHandler;
