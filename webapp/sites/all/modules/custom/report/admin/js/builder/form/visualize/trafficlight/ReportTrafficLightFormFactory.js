...
(function(global,$,undefined) {
    ...
    if ( typeof $ === 'undefined' ) {
        throw new Error('ReportTrafficLightFormFactory requires jQuery');
    }

    if ( typeof global.GD === 'undefined' ) {
        throw new Error('ReportTrafficLightFormFactory requires GD');
    }

    var GD = global.GD;

    global.GD.ReportTrafficLightFormFactory = {

        getForm: function ( format, container, options ) {
            var form = null;

            form = new GD.ReportTrafficLightStandardForm(format,container,options);
