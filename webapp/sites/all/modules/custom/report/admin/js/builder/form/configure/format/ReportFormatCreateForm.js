...
(function(global,$,undefined) {
    ...
    if ( typeof $ === 'undefined' ) {
        throw new Error('ReportFormatCreateForm requires jQuery');
    }

    if ( typeof global.GD === 'undefined' ) {
        throw new Error('ReportFormatCreateForm requires GD');
    }

    var GD = global.GD;

    var ReportFormatCreateForm = GD.View.extend({
        formContainer: null,
        ...
        loadColumns: function () {
            ...
            for ( var i = 0, count = columns.length; i < count; i++ ) {
                ...
                if ( columnDetails && !reportObj.findColumnConfig(columnDetails.id) ) {
        ...
        getFormContainer: function() {
            if ( !this.formContainer ) {
                this.formContainer = $('<div></div>').append('<h5>Select a column to format</h5>', this.getColumnSelector(), this.getActionButtons());
            }
    ...
    GD.ReportFormatCreateForm = ReportFormatCreateForm;
