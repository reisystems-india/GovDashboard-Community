...
def initiateOperator(operatorName, parameterValues = None):
    ...
    if (parameterValues is None):
        operator = classRef()
    elif (isinstance(parameterValues, dict)):
        operator = classRef(**parameterValues)
    elif (isinstance(parameterValues, list)):
        operator = classRef(*parameterValues)
    else:
        operator = classRef([parameterValues])
