...
class ReferenceLinkBuilder extends AbstractObject {
    ...
    public function prepareReferenceBranches($datasetName, array $referencePaths = NULL) {
        ...
        if (isset($referencePaths)) {
            foreach ($referencePaths as $referencePath => $required) {
                LogHelper::log_debug(t('Prepare dataset sequence for the reference: %referencePath', array('%referencePath' => $referencePath)));
